            ...
            <div className="flex h-full flex-col justify-between">
                ...
                <div className="flex justify-center space-x-5 p-6">
                    ...
                    <a type="button" className="text-white bg-[#1da1f2] hover:bg-[#1da1f2]/90 focus:ring-4 
                        ...
                        inline-flex items-center dark:focus:ring-[#1da1f2]/55 me-2 mb-2" href="https://x.com/NotusOptions">
                        Twitter
                    ...
                    <a type="button" className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 
                        ...
                        inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 me-2 mb-2"
