                            ...
                            <div className='w-full flex items-center justify-between text-white p-6 mb-8 shadow-lg border border-neutral-700 rounded-lg space-x-5'>
                                <div className='flex flex-col space-y-4'>
                                    ...
                                    <div className='flex justify-center'>
                                        <button className="flex justify-center w-full top-3 left-3 bg-green-500 text-white px-3 py-2 md:px-4 md:py-3 rounded-md opacity-80 hover:opacity-100 text-xs md:text-lg"
                                            onClick={deposit}>
                                            {isLoadingDeposit ? (
                                ...
                                <div className='flex flex-col space-y-4'>
                                    <div className="relative rounded-md shadow-sm">
                                        ...
                                        <input
                                            type="number" name="withdrawAmount" id="amount" className="w-full block rounded-md border-0 py-1.5 pl-7 text-white ring-1 ring-inset ring-gray-300 
                                            placeholder:text-xs md:placeholder:text-lg placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="USDA Amount"
                                            value={withdrawAmount} onChange={handleInputChange} />
                                    </div>
                                    <div className='flex justify-center'>
                                        <button className="w-full flex justify-center bg-red-500 text-white px-3 py-2 md:px-4 md:py-3 rounded-md opacity-80 hover:opacity-100 text-xs md:text-lg"
                                            onClick={withdraw}>
                                            {isLoadingWithdraw ? (
                                                <FaSpinner className="animate-spin" /> // Show spinner if loading
                                            ) : (
