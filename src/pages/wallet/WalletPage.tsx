...
const WalletPage: React.FC = () => {
  ...
  const deposit = async () => {
    ...
    const send = async (): Promise<void> => {
      ...
      try {
        // Send message for USDA transfer using othent signer
        const getSwapMessage = await message({
          ...
          signer: createDataItemSigner(othent), // using othent
        });
    ...
    try {
      ...
      // Create the deposit trade using othent signer
      const getPropMessage = await message({
        ...
        signer: createDataItemSigner(othent), // use othent signer here
      });
  ...
  useEffect(() => {
    const fetchTransactions = async () => {
      try {
        // Fetch transactions using othent signer
        const messageResponse = await message({
          process: AOC,
        ...
        console.error(error);
        alert("There was an error when loading transactions: " + error);
      }
    };
